...
const JobDetails = () => {
  ...
  const [ sendRepaly ] = useReplayMutation();

const handleApply = () => {
  if (user.role === "employee") {
    toast.error("You Need a Candidate Account to Appply!!")
  }
  if (user.role === "") {
    navigate('/register')
  }
...
console.log("all Data", data?.data);
  return (
    <div className='pt-14 grid grid-cols-12 gap-10'>
            ...
            <div className='text-primary my-2'>
              {queries?.map(({ question, email, reply, id }) => (
                <div>
                 ...
                 { user.role === "employee" && ( <div className='flex gap-3 my-5'>
